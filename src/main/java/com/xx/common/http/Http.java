package com.xx.common.http;


import com.fasterxml.jackson.databind.JavaType;
import com.github.kevinsawicki.http.HttpRequest;
import com.xx.common.exception.HttpException;
import com.xx.common.json.JsonUtils;
import com.xx.common.json.Jsons;
...
public class Http {
    ...
    public <T> T request(Class<T> target){
        return JsonUtils.readJsonToBean(request(), target);
    }
